...
2)  Import the list of SIPS from Remedial Action Profile ([SIPS_UC6_Anti-Swing_Belgovia.xml](https://github.com/entsoe-tso/relicapgrid/blob/main/Instance/NetworkCode/Belgovia/Belgovia_instance/SIPS/SIPS_UC6_Anti-swing_Belgovia.xml)).
