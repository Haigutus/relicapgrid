...
https://github.com/griddigit-eu[griddigit-eu] and https://github.com/Sveino[Sveino]. They have write rights.

*Reviewers:* 

all great contributors are relevant as first reviewer: (https://github.com/griddigit-ci[griddigit-eu] and https://github.com/Sveino[Sveino]), second review must be performed by a maintainer. They have write rights. They manage issues and close them.
...
They grant the appropriate access rights.
...
- Organisation(s) to which the applicant belongs to and, when applicable, the working group, task force or similar the applicant participates in. - A list of projects the applicant participates within their company (TSO, RCC, software vendor, etc.). - Details about the applicant’s professional background, areas of expertise, etc. - The number of contributions in this or other relevant projects (e.g., a screenshot of contributions, such as https://github.com/entsoe-tso/NetworkCodeProfiles/graphs/contributors[ENTSO-E Network Code Profiles repository contributions]).
